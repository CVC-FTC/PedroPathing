...
@Autonomous(name = "Large Triangle Simple Left", group = "Autonomous")
@Configurable // Panels
public class LargeTriangleSimpleLeft extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(
                new Pose(22.000, 123.000, Math.toRadians(-144.000))
        );
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            line1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(22.000, 123.000), new Pose(17.000, 97.000))
                    )

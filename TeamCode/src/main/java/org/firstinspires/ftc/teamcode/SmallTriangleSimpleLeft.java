...
@Autonomous(name = "Small Triangle Simple Left", group = "Autonomous")
@Configurable // Panels
public class SmallTriangleSimpleLeft extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(56.000, 9.000, Math.toRadians(90.000)));
            ...
            line1 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(50.871, 15.917),
                                    new Pose(33.362, 13.448)
                            )
                    )

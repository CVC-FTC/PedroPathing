...
@Autonomous(name = "Small Triangle Simple Right", group = "Autonomous")
@Configurable // Panels
public class SmallTriangleSimpleRight extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(87.000, 9.000, Math.toRadians(90.000)));
            ...
            line1 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(87.000, 24.321),
                                    new Pose(110.681, 15.831)
                            )
                    )
